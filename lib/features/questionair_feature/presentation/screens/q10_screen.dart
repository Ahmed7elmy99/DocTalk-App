...
import 'package:doc_talk/features/questionair_feature/presentation/screens/q11_screen.dart';
...
class Q10Screen extends StatelessWidget {
  Q10Screen({Key? key, required this.surveyModel, required this.answerIds}) : super(key: key);
        ...
        children: [
          ...
          Expanded(
            ...
            child: Container(
              ...
              context,
              MaterialPageRoute(builder: (context) => Q11Screen(
